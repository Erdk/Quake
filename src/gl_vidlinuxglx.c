...
static void HandleEvents(void)
{
	...
	if (dowarp) {
		...
		glfwSetCursorPos(vid.window, vid.width/2, vid.height/2);
	}
...
// set vid parameters
	...
	vid.aspect = ((float)vid.height / (float)vid.width) * (1280.0 / 720.0);
	vid.numpages = 2;
